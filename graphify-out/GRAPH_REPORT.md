...
## Corpus Check
- 130 files · ~156,720 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1030 nodes · 1937 edges · 68 communities (60 shown, 8 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `464ff63c`
...
Cohesion: 0.07
Nodes (43): ConquisteMapProps, ITALIA, dotForRank(), cittaFuoriMappa(), deriveMappa(), formaDelPin(), grafiaPiuRecente(), Gruppo (+35 more)
...
Cohesion: 0.16
Nodes (19): deriveDiary(), diario, entries(), entry(), FULL_YEAR, kinds(), seasonRich(), seasonWith() (+11 more)
...
Cohesion: 0.17
Nodes (15): Badge(), EmptyNote(), MeterRow(), PartnerCard(), PhaseCard(), PlacementCard(), PointsCard(), RecentTornei() (+7 more)
...
Cohesion: 0.12
Nodes (13): PhotoLightboxProps, Shot, BackLink(), MatchRow(), StatGrid(), StatTile(), KeyNumbers(), CompagnoDetailData (+5 more)
...
Cohesion: 0.11
Nodes (10): FilterChips(), SegmentedControl(), MappaCitta, MappaData, MappaTier, MappaTorneoRow, TorneiListData, ConquisteMap (+2 more)
...
Cohesion: 0.13
Nodes (17): Avatar(), BadgeSize, BadgeTone, btnBase, BtnVariant, Button(), EmptyCard(), FilterOption (+9 more)
...
Cohesion: 0.31
Nodes (5): BottomNavProps, NAV, NavEntry, SidebarProps, Screen
...
Cohesion: 0.33
Nodes (8): dashServer(), svDash(), decorateTournament(), deriveDashboardServer(), dotFor(), torneoRow(), fmtDate(), placementRank()
...
Cohesion: 0.20
Nodes (12): DiarySearchFields, cervia, jesolo, renderMappa(), rimini, spiaMappa, DiaryEntryOver, makeDiaryMatchHit() (+4 more)

### Community 62 - "Community 62"
Cohesion: 0.19
Nodes (6): Props, renderScreen(), dati, searchBox(), type(), expectNoA11yViolations()
...
Cohesion: 0.46
Nodes (6): isSubsequence(), matchesAllTokens(), normalizeText(), tokenize(), tokenMatchesField(), makeDiaryEntry()

## Knowledge Gaps
- **420 isolated node(s):** `allow`, `name`, `private`, `version`, `type` (+415 more)
...
- **Why does `AnyForm` connect `Community 65` to `Community 64`, `Community 66`, `Community 3`, `Community 2`, `Community 14`, `Community 52`, `Community 56`?**
  _High betweenness centrality (0.007) - this node is a cross-community bridge._
- **Why does `Option` connect `Community 65` to `Community 64`, `Community 3`, `Community 8`, `Community 10`, `Community 56`?**
  _High betweenness centrality (0.005) - this node is a cross-community bridge._
- **Why does `WrappedData` connect `Community 6` to `Community 10`, `Community 5`?**
