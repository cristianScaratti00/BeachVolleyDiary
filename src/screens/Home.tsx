    ...
    <div style={{ animation: "pop .32s ease both" }}>
      ...
      >
        ...
        <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
          ...
          {canFilter ? (
            ...
            <div
              onClick={onLockedFilter}
              title="Disponibile con Premium"
              style={{
                display: "inline-flex",
                alignItems: "center",
                gap: 8,
            ...
            >
              ...
              >
                🔒 Filtra compagno e anno
              </span>
              <span
                style={{
                  font: "800 8.5px 'Nunito Sans'",
                  letterSpacing: ".4px",
      ...
      >
        <div style={cell}>
          <div
            className="num"
            style={{ fontSize: 40, color: "#FF6B35", lineHeight: 1 }}
          >
            {s.winPct}%
          </div>
          <div className="lbl" style={{ marginTop: 6 }}>
            Vittorie · {s.won}/{s.played}
          </div>
        </div>
        <div style={cell}>
        ...
        <div style={cell}>
          <div className="num" style={{ fontSize: 40, lineHeight: 1 }}>
            {s.tWon}
            <span style={{ fontSize: 20, color: "rgba(27,42,74,.3)" }}>
              {" "}
              / {s.tPlayed}
            </span>
          </div>
          <div className="lbl" style={{ marginTop: 6 }}>
            Tornei vinti · {s.podi} podi
          </div>
        </div>
        <div style={cell}>
          <div className="num" style={{ fontSize: 40, lineHeight: 1 }}>
      ...
      <button
        ...
        style={{
          ...
          marginTop: 16,
          cursor: "pointer",
          border: `1px solid ${canAiCreate ? "rgba(255,107,53,.35)" : "rgba(27,42,74,.12)"}`,
          background: canAiCreate
            ? "linear-gradient(115deg,#FFF1E8 0%,#FFF8F0 58%)"
            : "#fff",
          borderRadius: 14,
          padding: 20,
          display: "flex",
      ...
      >
        <div
          style={{
            ...
            fontSize: 23,
            flex: "none",
            boxShadow: "0 6px 16px -7px rgba(255,107,53,.75)",
            opacity: canAiCreate ? 1 : 0.82,
          }}
        >
          ✨
        </div>
        <div style={{ flex: 1, minWidth: 190 }}>
          ...
          >
            ...
            >
              Crea un torneo con l’assistente AI
            </span>
            <span
              style={{
                font: "800 8.5px 'Nunito Sans'",
      ...
      <div
        className="card"
        style={{ padding: "22px 22px 14px", marginTop: 16 }}
      >
        <div
          style={{
            display: "flex",
        ...
        >
          ...
          {s.trendHasData && (
            <div
              style={{ font: "700 13px 'Nunito Sans'", color: s.trendColor }}
            >
              {s.trendLabel}
            </div>
          )}
              ...
              style={
                {
                  "--len": 100,
                  strokeDasharray: 100,
                  animation: "dash 1.2s ease .1s both",
                } as StyleWithVars
              }
            />
            {s.trendPts.map((pt, i) => (
      ...
      >
        <div className="card" style={{ padding: 22 }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: 24 }}>
            <svg
              viewBox="0 0 120 120"
              style={{ width: 112, height: 112, flex: "none" }}
            >
              <circle
                cx="60"
                cy="60"
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 16 }}>
            ...
            >
              <div>
                ...
                <div className="lbl">media fatti</div>
              </div>
              <div>
                <div className="num" style={{ fontSize: 20 }}>
                  {s.avgAg}
                </div>
                <div className="lbl">media subiti</div>
              </div>
            </div>
          </div>
        </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 15 }}>
              {s.phaseRows.map((p) => (
                <div key={p.phase}>
                  ...
                  >
                    <span style={{ font: "700 13px 'Nunito Sans'" }}>
                      {p.phase}
                    </span>
        ...
        {recent.map((t) => (
          <div
            ...
            style={{
              ...
              padding: "16px 18px",
              cursor: "pointer",
              borderBottom: "1px solid rgba(27,42,74,.07)",
            }}
          >
            <div
              style={{
