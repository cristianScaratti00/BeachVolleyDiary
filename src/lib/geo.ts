...
// ---------------------------------------------------------------------------
// Il campo città dei modali è testo libero (`tournaments.city` è `text` senza
// CHECK): questa lista alimenta un `<datalist>`, che suggerisce senza vincolare.
// È il vero rimedio ai refusi — una città scritta bene si geocodifica, e chi
// gioca altrove continua a scrivere quello che vuole.
//
