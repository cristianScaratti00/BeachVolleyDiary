  ...
  return (
    <aside
      style={{
        ...
        overflowY: "auto",
        padding: "28px 16px",
        borderRight: "1px solid rgba(27,42,74,.09)",
        display: "flex",
    ...
    >
        ...
        return (
          <div
            ...
            style={{
              ...
              color: active ? "#1B2A4A" : "rgba(27,42,74,.4)",
              borderLeft: `2px solid ${active ? "#FF6B35" : "transparent"}`,
            }}
          >
            <NavIcon screen={n.key} size={19} />
            {n.label}
          </div>
        );
      })}
      ...
      <div
        ...
        style={{
          ...
          boxShadow: "0 8px 20px -10px rgba(255,107,53,.8)",
        }}
      >
      ...
      <div
        style={{
          marginTop: 12,
          paddingTop: 12,
          borderTop: "1px solid rgba(27,42,74,.09)",
          display: "flex",
          alignItems: "center",
          gap: 10,
        }}
